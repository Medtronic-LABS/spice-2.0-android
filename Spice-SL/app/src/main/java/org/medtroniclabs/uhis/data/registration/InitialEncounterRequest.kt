...
data class InitialDiagnosis(
    ...
    var isMentalHealthDiagnosis: Boolean? = null,
    var mentalHealthDisorderType: String? = null,
    var mentalHealthYearOfDiagnosis: String? = null,
    var mentalHealthCondition: String? = null,
)
