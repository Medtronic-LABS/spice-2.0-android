...
object IntentConstants {
    ...
    const val INTENT_PATIENT_ID_STRING = "patientIdString"
    const val INTENT_VISIT_ID = "patientVisitId"
    const val INTENT_ENCOUNTER_REFERENCE = "encounterReference"
    const val INTENT_MEMBER_REFERENCE = "memberReference"
    const val INTENT_PATIENT_REFERENCE = "patientReference"
    const val INTENT_PATIENT_INITIAL = "intentPatientInitial"
    const val INTENT_INITIAL_REVIEW = "initialReview"
