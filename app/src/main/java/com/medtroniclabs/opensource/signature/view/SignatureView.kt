package com.medtroniclabs.opensource.signature.view
...
import com.medtroniclabs.opensource.custom.signature.utils.Bezier
import com.medtroniclabs.opensource.custom.signature.utils.ControlTimedPoints
import com.medtroniclabs.opensource.custom.signature.utils.TimedPoint
import kotlin.math.max
import kotlin.math.roundToInt
import com.medtroniclabs.opensource.R.styleable
import com.medtroniclabs.opensource.custom.signature.view.ViewTreeObserverCompat
...
//        val bundle = Bundle()
//        bundle.putParcelable("superState")
...
//        )
    ...
    fun setSignatureBitmap(signature: Bitmap) {
        if (isLaidOut()) {
            ...
            val vWidth = width - 24
            val vHeight = height - 24
            // Generate the required transform.
            tempSrc[0f, 0f, dWidth.toFloat()] = dHeight.toFloat()
            tempDst[12f, 12f, vWidth.toFloat()] = vHeight.toFloat()
