package com.medtroniclabs.opensource.ui.assessment.referrallogic.model

object ReferralDefinedParams {
    ...
    const val MaxTemperature = 37.5
    const val NoOfDaysOfFever = "noOfDaysOfFever"
    const val MaxDaysOfFever = 7
